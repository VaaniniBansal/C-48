...
function setup() {
  ...
  //m = createSprite(100,200,500,20);
    ...
    m3= createSprite(265,145,10,100);
    m4= createSprite(145,190,120,10);
    m5= createSprite(320,190,120,10);
    m6= createSprite(90,245,10,120);
    m7= createSprite(385,245,10,120);
    ...
    m31= createSprite(980,190,12,90);
    m32= createSprite(1100,230,250,10);
